...
RUN apt-get update && apt-get install -y \
    ...
    ros-${ROS_DISTRO}-examples-rclcpp-minimal-service \
    # Libraries
    rapidjson-dev \
    # Debugging tools
    gdb \
